			...
			<td class="addPictureTableTD">
				<div>
						...
						<div class="panel-body">
							<form method="post" class="addFormSingle" action="admin_productImage_add" enctype="multipart/form-data">
								<table class="addTable">
									...
									<tr>
										<td>
											<input id="fielpatehSingle" type="file" name="filepath" />
										</td>
									</tr>
									<tr class="submitTR">
										<td align="center">
					...
					<table class="table table-striped table-bordered table-hover table-condensed">
						...
						<tbody>
							<c:forEach items="${simg}" var="pi">
								<tr>
									<td>${pi.id}</td>
									<td>
										<a title="点击查看原图" href="img/productSingle/${pi.id}.jpg"><img height="50px" src="img/productDetail/${pi.id}.jpg"></a>
									</td>
									<td>
						...
						<div class="panel-body">
							<form method="post" class="addFormDetail" action="admin_productImage_add" enctype="multipart/form-data">
								<table class="addTable">
									...
									<tr>
										<td>
											<input id="fielpatehDetial" type="file" name="filepath" />
										</td>
									</tr>
									<tr class="submitTR">
										<td align="center">
