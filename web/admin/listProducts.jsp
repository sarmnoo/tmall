			...
			<tbody>
				<c:forEach items="${ps}" var="p">
					<tr>
						...
						<td>${p.stock}</td>
						<td>
							<a href="admin_productImage_list?pid=${p.id}"><span class="glyphicon glyphicon-edit"></span></a>
						</td>
						<td>
							<a href="admin_product_editPropertyValue?pid=${p.id}"><span class="glyphicon glyphicon-edit"></span></a>
						</td>
						<td>
							<a href="admin_product_edit?pid=${p.id}"><span class="glyphicon glyphicon-edit"></span></a>
						</td>
						<td>
