...
public class BackServletFilter implements Filter {
	...
	String uri = request.getRequestURI();//request.getRequestURI()：取出访问的uri: /tmall/admin_category_list
		...
		if(uri.startsWith("/admin_")){ //判断其是否以/admin开头,如果是，那么就取出两个_之间的字符串，category，并且拼接成/categoryServlet，通过服务端跳转到/categoryServlet
			String servletPath = StringUtils.substringBetween(uri, "_","_")+"Servlet"; //取出两个 _ 之间的字符串，category
